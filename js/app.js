(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-master-class")) new core(".swiper-master-class", {
            modules: [ Navigation, Pagination, Autoplay ],
            effect: "fade",
            centeredSlides: true,
            observer: true,
            ...
            navigation: {
                prevEl: ".master-class-button-prev",
                nextEl: ".master-class-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".promotions-slide-swiper")) new core(".promotions-slide-swiper", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            watchOverflow: true,
            observeParents: true,
            ...
            loop: true,
            pagination: {
                el: ".promotions-slide-pagination",
                clickable: true,
                dynamicBullets: true
            },
            navigation: {
                prevEl: ".promotions-slide-button-prev",
                nextEl: ".promotions-slide-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
